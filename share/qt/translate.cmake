...
function(extract_strings output)
  ...
  file(STRINGS "aureusstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *aureus_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"aureus-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/aureusstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/aureusstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/aureus_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/aureus_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/aureus_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/aureus_en.xlf" aureus_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" aureus_en "${aureus_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" aureus_en "${aureus_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/aureus_en.xlf" "${aureus_en}")
