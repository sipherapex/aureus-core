...
{
    BOOST_CHECK(TestSplitHost("www.aureuscore.org", "www.aureuscore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.aureuscore.org]", "www.aureuscore.org", 0));
    BOOST_CHECK(TestSplitHost("www.aureuscore.org:80", "www.aureuscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.aureuscore.org]:80", "www.aureuscore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.aureuscore.org:65536", "www.aureuscore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.aureuscore.org:0", "www.aureuscore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.aureuscore.org:", "www.aureuscore.org:", 0, false));
}
