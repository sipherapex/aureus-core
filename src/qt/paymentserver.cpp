...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // aureus: URI
        {
...
//
// OSX-specific way of handling aureus: URIs
//
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("aureus://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'aureus://' is not a valid URI. Use 'aureus:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // aureus: URI
    {
