...
#include <aureus-build-config.h> // IWYU pragma: keep

#include <qt/aureusgui.h>
 ...
 *
 * Ref: https://github.com/aureus/aureus/pull/1026
 */
...
AureusGUI::AureusGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &AureusGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &AureusGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &AureusGUI::showModalOverlay);
...
void AureusGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &AureusGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &AureusGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &AureusGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Aureus Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Aureus Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a aureus: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Aureus command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &AureusGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &AureusGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &AureusGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &AureusGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &AureusGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &AureusGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &AureusGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &AureusGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &AureusGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &AureusGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &AureusGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &AureusGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &AureusGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &AureusGUI::showDebugWindow);
}
...
void AureusGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &AureusGUI::setCurrentWalletBySelectorIndex);
...
void AureusGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &AureusGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &AureusGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &AureusGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &AureusGUI::showProgress);
...
#ifdef ENABLE_WALLET
void AureusGUI::enableHistoryAction(bool privacy)
{
...
void AureusGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &AureusGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &AureusGUI::removeWallet);
...
WalletController* AureusGUI::getWalletController()
{
    return m_wallet_controller;
}

void AureusGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &AureusGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &AureusGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &AureusGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &AureusGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &AureusGUI::incomingTransaction);
    connect(this, &AureusGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void AureusGUI::removeWallet(WalletModel* walletModel)
{
...
void AureusGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void AureusGUI::setCurrentWalletBySelectorIndex(int index)
{
...
void AureusGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &AureusGUI::toggleHidden);
...
void AureusGUI::gotoLoadPSBT(bool from_clipboard)
{
...
void AureusGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Aureus network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void AureusGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void AureusGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void AureusGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &AureusGUI::quitRequested);
...
void AureusGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void AureusGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &AureusGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void AureusGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void AureusGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &AureusGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &AureusGUI::show);
                e->ignore();
            }
        }
    }
...
#ifdef ENABLE_WALLET
void AureusGUI::incomingTransaction(const QString& date, AureusUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
void AureusGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void AureusGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void AureusGUI::updateProxyIcon()
{
    std::string ip_port;
...
void AureusGUI::updateWindowTitle()
{
...
static bool ThreadSafeMessageBox(AureusGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = AureusGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
bool AureusGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<AureusUnit> units = AureusUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const AureusUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, AureusUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const AureusUnit u : AureusUnits::availableUnits()) {
        menu->addAction(AureusUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(AureusUnit newUnits)
{
    setText(AureusUnits::longName(newUnits));
}
