      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->aureusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aureusAtStartup);
    ...
    ui->aureusAtStartup->setToolTip(ui->aureusAtStartup->toolTip().arg(CLIENT_NAME));
    ui->aureusAtStartup->setText(ui->aureusAtStartup->text().arg(CLIENT_NAME));

    ui->openAureusConfButton->setToolTip(ui->openAureusConfButton->toolTip().arg(CLIENT_NAME));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSAURontrols);
...
void OptionsDialog::on_openAureusConfButton_clicked()
{
