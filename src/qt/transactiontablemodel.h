...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AureusUnits::SeparatorStyle separators=AureusUnits::SeparatorStyle::STANDARD) const;
