...
{
    // Test regression https://github.com/aureus/aureus/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/aureus-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/aureus-core/gui/pull/568.
    // With fListen=false in ~/.config/Aureus/Aureus-Qt.conf and all else left as default,
    // aureus-qt should set both -listen and -listenonion to false and start successfully.
