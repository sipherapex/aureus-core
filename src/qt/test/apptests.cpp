...
//! Entry point for AureusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AureusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AureusGUI tests.
void AppTests::guiTests(AureusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AureusGUI::consoleShown, this, &AppTests::consoleTests);
