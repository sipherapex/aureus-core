...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = AureusUnits::formatWithUnit(unit, amount, true, AureusUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    AureusUnit unit{AureusUnit::AUR};
...
{
    AureusUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(AureusUnits::formatWithPrivacy(unit, balances.balance, AureusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(AureusUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, AureusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(AureusUnits::formatWithPrivacy(unit, balances.immature_balance, AureusUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(AureusUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, AureusUnits::SeparatorStyle::ALWAYS, m_privacy));
