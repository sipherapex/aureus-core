...
public:
    ...
    AureusUnit getDisplayUnit() const { return m_display_aureus_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSAURontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    AureusUnit m_display_aureus_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AureusUnit unit);
