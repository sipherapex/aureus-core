...
public:
    ...
    explicit AureusGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AureusGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, AureusUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Aureus Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(AureusUnit newUnits);
