...
extern thread_local ThreadContext g_thread_context; // NOLINT(aureus-nontrivial-threadlocal)
// Silence nonstandard aureus tidy error "Variable with non-trivial destructor
