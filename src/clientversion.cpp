 ...
 * for both aureusd and aureus-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <aureus-build-info.h>
// The <aureus-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Aureus Core copyright is not removed by accident
    if (copyright_devs.find("Aureus Core") == std::string::npos) {
