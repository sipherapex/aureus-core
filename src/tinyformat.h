...
#include <algorithm>
#include <attributes.h> // Added for Aureus Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Aureus Core
#include <util/string.h> // Added for Aureus Core
...
// Added for Aureus Core. Similar to std::runtime_format from C++26.
...
// Added for Aureus Core. Wrapper for checking format strings at compile time.
