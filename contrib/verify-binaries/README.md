...
As of Aureus Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/aureus-core/guix.sigs/). When
...
builder-keys](https://github.com/aureus-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://aureuscore.org and https://aureus.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/aureus-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/aureus-24.0.1-arm-linux-gnueabihf.tar.gz
```
