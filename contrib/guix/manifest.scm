...
(define* (make-aureus-cross-toolchain target
                                       #:key
...
desirable for building Aureus Core release binaries."
...
;; failure; see https://github.com/aureus/aureus/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-aureus-cross-toolchain target)))
