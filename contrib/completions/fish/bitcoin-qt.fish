...
complete --command aureus-qt --no-files

# Extract options
function __fish_aureusqt_get_options
...
complete \
    --command aureus-qt \
    --arguments "(__fish_aureusqt_get_options --nofiles)"
