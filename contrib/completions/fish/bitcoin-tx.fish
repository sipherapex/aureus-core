...
# Extract options
function __fish_aureus_tx_get_options
...
# Extract commands
function __fish_aureus_tx_get_commands
...
complete \
    --command aureus-tx \
    --condition "not __fish_aureus_seen_cmd (__fish_aureus_tx_get_commands --commandsonly)" \
    --arguments "(__fish_aureus_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command aureus-tx \
    --arguments "(__fish_aureus_tx_get_commands)" \
    --no-files
