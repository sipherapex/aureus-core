...
"""Example logging Aureus Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of aureusd>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[aureusd_with_usdts])
