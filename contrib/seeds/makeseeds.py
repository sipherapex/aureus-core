#!/usr/bin/env python3
# Copyright (c) 2013-present The Aureus Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of aureus node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple aureus ports', file=sys.stderr)
