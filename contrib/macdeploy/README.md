...
When complete, it will have produced `Aureus-Core.zip`.
...
apt install cpio
git clone https://github.com/aureus-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/aureus-core/aureus-detached-sigs).
