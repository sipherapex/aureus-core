...
BITCOIND=${BITCOIND:-$BINDIR/aureusd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/aureus.conf}
...
then
  ...
  echo -e "To safely generate a aureus.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example aureus.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-aureus-conf.sh.
##
...
# parse the output from aureusd --help
