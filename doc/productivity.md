...
```sh
cmake --build build --target aureusd aureus-cli
cmake --build build --target aureus-qt
cmake --build build --target bench_aureus
```
...
> e.g. github.com/aureus/aureus.git or for the GUI github.com/aureus-core/gui
