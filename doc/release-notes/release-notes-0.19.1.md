...
Aureus Core version 0.19.1 is now available from:

  <https://aureuscore.org/bin/aureus-core-0.19.1/>
...
From Aureus Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Aureus Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Aureus Core does not yet change appearance when
...
- #17488 fix "aureusd already running" warnings on macOS (fanquake)
