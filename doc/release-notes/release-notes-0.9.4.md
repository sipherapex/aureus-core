Aureus Core version 0.9.4 is now available from:

  https://aureus.org/bin/0.9.4/
...
this update is incompatible with the Aureus system and could lead to consensus
forks.

Aureus Core released binaries from https://aureus.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aureus/+archive/ubuntu/aureus
- A third-party or self-compiled Aureus Core

upgrade to Aureus Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
