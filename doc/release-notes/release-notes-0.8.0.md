Aureus-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aureus/files/Aureus/aureus-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Aureus
...
New/changed settings (command-line or aureus.conf file)
--------------------------------------------------------
