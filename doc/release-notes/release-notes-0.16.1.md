Aureus Core version 0.16.1 is now available from:

  <https://aureuscore.org/bin/aureus-core-0.16.1/>
...
- #12843 `df38b13` Test starting aureusd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure aureusd processes are cleaned up when tests end (sdaftuar)
