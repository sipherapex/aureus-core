Aureus version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aureus/files/Aureus/aureus-0.5.4/
...
http://gitorious.org/aureus/aureusd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aureus-Qt notifications under Growl 1.3.
Increase required age of Aureus-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAureus properly when installing Aureus-Qt over it. (Windows)
