Aureus Core version *0.15.2* is now available from:

  <https://aureuscore.org/bin/aureus-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in aureus-tx (TheBlueMatt)
