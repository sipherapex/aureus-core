Aureus Core version 27.0 is now available from:

  <https://aureuscore.org/bin/aureus-core-27.0/>
...
- libaureusconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libaureuskernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Aureus Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Aureus Core would
