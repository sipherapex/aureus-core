Aureus Core version 0.10.4 is now available from:

  <https://aureus.org/bin/aureus-core-0.10.4/>
...
- #6953 `43c2789` Split aureus-tx into its own package
- #6953 `dfe0d4d` Include aureus-tx binary on Debian/Ubuntu
