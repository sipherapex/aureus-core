...
Aureus Core version v30.1 is now available from:

  <https://aureuscore.org/bin/aureus-core-30.1/>
...
- #33229 multiprocess: Don't require aureus -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.aureus.dashjr-list-of-p2p-nodes.us
