# PSBT Howto for Aureus Core

Since Aureus Core 0.17, an RPC interface exists for Partially Signed Aureus
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/aureus/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Aureus transactions that are not fully signed
...
#### Multisig with multiple Aureus Core instances
