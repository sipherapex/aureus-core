...
Assumeutxo is a feature that allows fast bootstrapping of a validating aureusd
instance.
...
```
$ aureus-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ aureus-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
