...
maintained:
* for `src/crc32c`: https://github.com/aureus-core/crc32c-subtree.git (branch aureus-fork)
* for `src/crypto/ctaes`: https://github.com/aureus-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/aureus-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/aureus-core/leveldb-subtree.git (branch aureus-fork)
* for `src/minisketch`: https://github.com/aureus-core/minisketch.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/aureus-core/secp256k1.git
```
