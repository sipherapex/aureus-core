...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"aureus-cli -h\" for help or \"aureus-cli listwallets\" to see "
...
class TestAureusCli(AureusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `aureus-cli getblockchaininfo`")
        ...
        # Prevent aureus-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and aureus-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and aureus-cli getwalletinfo return expected wallet info")
            ...
            # Test aureus-cli -generate with -rpcwallet in multiwallet mode.
