...
class P2PPrivateBroadcast(AureusTestFramework):
    ...
    def run_test(self):
        ...
        # Stop the SOCKS5 proxy server to avoid it being upset by the aureus
        ...
        self.restart_node(0, extra_args=[
            ...
            # Aureus Core to start, hoping/assuming that the location of the Tor proxy
