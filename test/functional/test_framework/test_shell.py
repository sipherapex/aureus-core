...
class TestShell:
    """Wrapper Class for AureusTestFramework.

    The TestShell class extends the AureusTestFramework
    ...
    class __TestShell(AureusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AureusTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # AureusTestFramework instances are supposed to be constructed with the path
