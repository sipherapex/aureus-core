...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AureusTestFramework
    pass


class ExampleTest(AureusTestFramework):
    # Each functional test is a subclass of the AureusTestFramework class.
    ...
    def custom_method(self):
        ...
        AureusTestFramework class so other tests can use it."""
