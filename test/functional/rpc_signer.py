...
Verify that a aureusd node can use an external signer command.
...
class RPCSignerTest(AureusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart aureusd with -signer=<cmd>',
