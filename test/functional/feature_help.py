...
"""Verify that starting aureus with -h works as expected."""

from test_framework.test_framework import AureusTestFramework
from test_framework.util import assert_equal

class HelpTest(AureusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aureus with -h for help text")
        ...
        self.log.info("Start aureus with -version for version information")
        ...
        self.log.info("Start aureusd with -fakearg to make sure it does not start")
