...
class TransactionTimeRescanTest(AureusTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine AUR and create transactions
        ...
        # generate some aur to create transactions and check blockcount
        ...
        # send 10 aur to user's first watch-only address
        self.log.info('Send 10 aur to user')
        ...
        # send 5 aur to our second watch-only address
        self.log.info('Send 5 aur to user')
        ...
        # send 1 aur to our third watch-only address
        self.log.info('Send 1 aur to user')
