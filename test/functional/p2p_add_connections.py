...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The aureusd node closes feeler connections as soon as a version
...
class P2PAddConnections(AureusTestFramework):
    ...
    def run_test(self):
        ...
        # aureusd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that aureusd sends its own version prior to processing
