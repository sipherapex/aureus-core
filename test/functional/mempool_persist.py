...
By default, aureusd will dump mempool on shutdown and
...
class MempoolPersistTest(AureusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aureusd from writing mempool.dat to disk. Verify that `savemempool` fails")
